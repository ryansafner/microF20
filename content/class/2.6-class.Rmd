...
Exam 2 will be made available next week. I will discuss it more on Wednesday.
...
s3<-ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "",
       y = "",
       title = "Area to Left of Supply Curve")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=12)
...
\color{green}{\pi} &= R(q) - VC(q)-FC\\	
					& \\ 
\color{green}{\pi}-\color{red}{PS}&=-FC\\
\color{green}{\pi}&=\color{red}{PS}-FC\\
\end{align*}$$
