---
title: "1.4 — Preferences and Utility — Class Notes"
citeproc: false
...
Note: I used to split this topic over 2 class periods, but this semester I am trying to trim some of the fat and merge it into a single class day. One reason is that this material is probably the most “alien” to you, and the second is that, while the details of preference modeling are extremely important if you decide to go to graduate school in economics,^[See [this tweet](https://twitter.com/graykimbrough/status/1291017699481575424) for an example of what you can expect in a common Ph.D textbook discussing preferences.] it is largely a waste for everyone else. I’d much rather spend more time on market power, entrepreneurship, and more useful concepts or models for the vast majority of you. Hence, a lot of the extra assumptions, technical details, and examples have been relegated to this “online appendix” below. 
...
Answers from [last class’ practice problems](/practice/1.4-practice) (on budget constraints) are posted on that page. Today you will be working on [practice problems](/practice/1.4-practice). Answers will be posted later.
...
These would be read as “*a* is at least as good as *b*” and “*b* is at least as good as *a*.” These are more technically complete, but it is much more simple for us to focus on strong preferences, and we don't lose much by doing so.
...
Of course, this means that this entire graph is *full* of indifference curves - every single possible point is on *some* indifference curve (and this whole graph would just be a solid block of blue). Naturally, it's pointless to draw all the indifference curves, we just want to show a few to make our analysis meaningful. But the general idea comes from assumption 2 of preferences: *any two bundles can be compared*, as we can compare two points on this graph and make a judgment.
