...
**Exam 2 will be available 8:00 AM Tuesday, September 15 through 10:00 PM Sunday September 20 on Blackboard**^[Go to our class Blackboard page, on the blue navigation bar on the left, click Assignments, you will find Exam 1.]
...
Note that we skipped some excess content about preferences this semester, so some things on the study guide (like assumptions about preferences, assumptions about indifference curves, indifference curves for non-goods -- the graph on page 4, steepness --graph on page 7--but know complements & substitues!), you can safely ignore.
