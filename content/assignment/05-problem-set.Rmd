...
- [<i class="fas fa-file-pdf"></i> `Download as PDF`](/assignment/05-problem-set-pdf.pdf)
- [<i class="far fa-life-ring"></i> Answer Key](/assignment/05-problem-set-answers.html)
- [<i class="fas fa-file-pdf"></i> Answer Key (PDF)](/assignment/05-problem-set-answers-pdf.pdf)
...
In your own words, explain what an externality is. Give an example, and draw a graph — either for a negative externality or a positive externality. Explain *several* possible ways that the problem can be solved.
