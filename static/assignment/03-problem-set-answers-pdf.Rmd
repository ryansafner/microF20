...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  labs(x = "Labor (l)",
       y = "Capital (k)")+
  ggthemes::theme_pander(base_size=14, base_family = "Fira Sans Condensed")
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  geom_label(aes(x=5, y=CC_2(5)), color="black", label="C=$30")+
  stat_function(fun=CC_3, geom="line", size=2, color="black")+
  geom_label(aes(x=8, y=CC_3(8)), color="black", label="C=$45")+
  geom_segment(aes(x=1, xend=1, y=5, yend=1), color="red", size=1)+
  geom_segment(aes(x=1, xend=10, y=1, yend=1), color="red", size=1)+
  geom_label(aes(x=9, y=1), color="red", label="q=10")+
  geom_segment(aes(x=2, xend=2, y=5, yend=2), color="blue", size=1)+
  geom_segment(aes(x=2, xend=10, y=2, yend=2), color="blue", size=1)+
  geom_label(aes(x=9, y=2), color="blue", label="q=20")+
  geom_segment(aes(x=3, xend=3, y=5, yend=3), color="green", size=1)+
  geom_segment(aes(x=3, xend=10, y=3, yend=3), color="green", size=1)+
  geom_label(aes(x=9, y=3), color="green", label="q=30")+
...
| $l$ | $q=100\sqrt{l}$ | $MP_l=\frac{\Delta q}{\Delta l}$ | $AP_l=\frac{q}{l}$ |
|-----|-----|--------|--------|
| $0$ | $100\sqrt{0}=0$ | $-$ | $-$ |
...
tot<-ggplot(data.frame(x=c(0,10)), aes(x=x))+
...
mar<-ggplot(data.frame(x=c(0,10)), aes(x=x))+
