...
11. Carl’s Coal Mining operates in a remote area. Because of its location, it has monopsony power in the local labor market for miners. Its marginal revenue product of labor is
$$MRP_L=800-10L$$
...
```{r}
mrp_l=function(q){800-10*q}
supply_l=function(q){10*q-100}
MC_l=function(q){20*q-100}
dwl_l<-tribble(
  ~x, ~y,
  30, 200,
  30, 500,
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  geom_label(aes(x=70,y=supply_l(70)), color = "red", label="Supply(L)", size = 4)+
  ...
  geom_segment(aes(x = 0, xend = 30, y = 500, yend=500), linetype="dotted", size=1)+
  geom_segment(aes(x = 0, xend = 30, y = 200, yend=200), linetype="dotted", size=1)+

  geom_segment(aes(x = 30, xend = 30, y = 500, yend=0), linetype="dotted", size=1)+
  geom_segment(aes(x = 0, xend = 45, y = 350, yend=350), linetype="dotted", size=1)+
  geom_segment(aes(x = 45, xend = 45, y = 350, yend=0), linetype="dotted", size=1)+

      geom_label(aes(x=5,y=200), label=expression(w[m]), size = 4)+
    geom_label(aes(x=5,y=350), label=expression(w[C]), size = 4)+

      geom_label(aes(x=45,y=50), label=expression(L[m]), size = 4)+
    geom_label(aes(x=30,y=50), label=expression(L[C]), size = 4)+
