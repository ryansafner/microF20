...
date: "Due by 11:59 PM Sunday, November 8, 2020 by PDF upload in Blackboard Assignments"
output:
  pdf_document:
    dev: cairo_pdf
...
7. In your own words, explain what an externality is. Give an example, and draw a graph — either for a negative externality or a positive externality. Explain *several* possible ways that the problem can be solved.
