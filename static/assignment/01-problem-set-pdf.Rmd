...
date: "Due by 11:59 PM Sunday, September 6, 2020 by PDF upload in Blackboard Assignments"
output: pdf_document
header-includes:
- \usepackage{amsmath}
...
b. Suppose he can choose between bundles^[Sandwiches, I suppose!] $a = (4,1)$, $b=(2,2)$, and $c=(4,1)$. Are these on the same indifference curve?
c. Would he prefer bundle $d = (2,1)$ over a bundle from part B? Why or why not?
d. Sketch a graph, plotting bundles $a, b, c$, and $d$. Indicate any indifference curve(s) they are on, and how much utility each provides.
