...
Below $20 of income, books are a normal good (the Engel curve slopes to the right, so as income increases, so does consumption), but above $20, books become an inferior good (the Engel curve slopes to the left, so as income increases, so consumption decreases).
