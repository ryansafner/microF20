...
### [When and Why Markets are Great](#3)
### [Market Efficiency and Welfare](#13)
### [Collective Action Problems](#27)
### [Public Goods](#34)
### [Externalities: When the Price Isn't Right](#43)
...
- Groups often do some combination of the following to overcome the problem:<sup>.magenta[†]</sup>
  - .hi[Sacrifice]: members need to invest in a costly and observable behavior: wear a particular outfit, attend meetings, learn rituals, pay dues, eat particular diet, etc.
  - .hi[Stigma]: members who don’t contribute or make the sacrifice are shamed & ostracized (or kicked out)

]

.tiny[<sup>.magenta[†]</sup> See [today’s readings page](/class/3.4-class) for great podcast and paper on the economics of religion using these tools.]
]
...
- Takes two parties to have a dispute: A $\iff$ B
...
.center[
![:scale 75%](https://www.dropbox.com/s/apo9rt8be2x6l6a/propertybundleofrights.png?raw=1)
]
...
goods<-tribble(
  ...
  "Rival", "(Houses, Jeans)", "(Environment, Wikipedia)",
  "Nonrival", "Club Goods", "Public Goods",
  "Nonrival", "(Swim Clubs, Cable TV)", "(Asteroid Defense, Vaccines)"
) 

goods[2,2]<-cell_spec(goods[2,2], "html", underline = F, color = "blue")
goods[2,3]<-cell_spec(goods[2,3], "html", underline = F, color = "blue")
goods[4,2]<-cell_spec(goods[4,2], "html", underline = F, color = "blue")
goods[4,3]<-cell_spec(goods[4,3], "html", underline = F, color = "blue")
...
table<-goods %>%
  ...
  row_spec(c(1), bold = T) %>%
  #row_spec(c(2,4), italic = T, color = "blue") %>%
  collapse_rows(columns = 1, latex_hline = "major", valign = "middle") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), html_font = "Fira Sans")
table
```
...
.pull-right[
.center[
![:scale 80%](../images/Wikipedia-paper.png)
]
]