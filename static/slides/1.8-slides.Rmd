...
$$\epsilon_{q,p} = \color{magenta}{\frac{\Delta q}{\Delta p}} \times \color{teal}{\frac{p}{q}}$$
...
- This is a more general formula, we can find the .hi-purple[elasticity at any *one* point]!
...
$$\color{red}{\mathbf{\epsilon_{q,p}} = \mathbf{\frac{1}{slope} \times \frac{p}{q}}}$$
...
- Price elasticity of demand is related to .hi[Revenues `\\((R)\\)`]
...
- See today's [class notes page](/class/1.8-class) for some applications of consumer theory:
