---
title: "1.4 — Preferences and Utility"
...
1. .hi-purple[We can always draw indifference curves]: two bundles can always be ranked

2. .hi-purple[Monotonic]: "more is preferred to less"

3. .hi-purple[Convex]: "averages are preferred to extremes"

4. .hi-purple[Indifference curves can never cross]: preferences are transitive
...
# Marginal Rate of Substitution vs. Budget Constraint Slope
...
- .hi-purple[Curvature] of indifference curves tells us how goods are related

- Relatively **straight** curves: goods are more .hi[substitutable] for one another

- Relatively **bent** curves: goods are more .hi[complementary] with one another
...
3. Is this curve convex? Hint: Does $MRS_{a,b} \downarrow$ as $a \uparrow$?
]
]